...
\begin{abstract}
  ...
  In this report we investigate a new Windows process injection attack, Mockingjay.
  To understand the threat, we propose a set of recommendations a CISO would utilise to mitigate the risk of a successful attack.
  ...
  In creating a more resilient cyber-security system, the CISO acts as an important strategic partner in the reduction of operational risk.
\end{abstract}
