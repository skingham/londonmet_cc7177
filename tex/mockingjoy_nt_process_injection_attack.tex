...
\addbibresource{assignment.bib} % BibLaTeX bibliography file
...
\footertext{\textit{Londonmet MSc CC7177 Cyber Security Unit} (Autumn 2023)} % Text to appear in the footer, leave this command empty for no footer text
...
%----------------------------------------------------------------------------------------
%
% Title Page {clear and concise- e.g. technical report title and module codeand title, plus your name and student ID number}
%
% Abstract Page
%
...
\title{Investigation of Wallet Hacks\\ Exploiting Browser Extenstions} % Article title, use manual lines breaks (\\) to beautify the layout

% Authors are listed in a comma-separated list with superscript numbers indicating affiliations
% \thanks{} is used for any text that should be placed in a footnote on the first page, such as the corresponding author's email, journal acceptance dates, a copyright/license notice, keywords, etc

% technical report title and module codeand title, plus your name and student ID number

\author{%
	Stuart Kingham \textsuperscript{1}\thanks{Author: \href{mailto:sdk0034@my.londonmet.ac.uk}{sdk0034@my.londonmet.ac.uk}\\ \textbf{Submitted:} December 14, 2023}
}

% Affiliations are output in the \date{} command
\date{\footnotesize\textsuperscript{\textbf{1}}School of ...., London Metropolitan University\\ }
